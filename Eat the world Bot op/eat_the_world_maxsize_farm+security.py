...
EAT_WORLD_SCRIPT = os.path.join(base_dir, "eat_the_world_maxsize_farm.py")
AUTOCLICK_STATUS_FILE = os.path.join(base_dir, "Autoclick_statue.txt")
CHEST_STATUS_FILE = os.path.join(base_dir, "Chest_statue.txt")
CHROME_URL_MACRO = os.path.join(base_dir, "chrome_url.exe")
RECONNECT_MACRO = os.path.join(base_dir, "reconnect.exe")
ROBLOX_CLOSE_FILE = os.path.join(base_dir, "close_roblox.exe")

# Liste des macros à vérifier et arrêter
MACROS_TO_STOP = [
    os.path.join(base_dir, "macro_debut.exe"),
    os.path.join(base_dir, "échap.exe"),
    os.path.join(base_dir, "macro_vente.exe"),
    os.path.join(base_dir, "macro_periodique3.exe"),
    os.path.join(base_dir, "macro_achat_muti.exe"),
]
