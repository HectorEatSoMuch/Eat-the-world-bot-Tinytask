...
AUTOCICK_PATH = r"C:\Users\camil\Desktop\Eat the world Bot op\Autoclick_statue.txt"
CHEST_PATH = r"C:\Users\camil\Desktop\Eat the world Bot op\Chest_statue.txt"
...
def wait_for_pixel_without_block(x, y, color):
    ...
    while True:
        ...
        process_vente = execute_macro(r"C:\Users\camil\Desktop\Eat the world Bot op\macro_vente.exe")
...
def main():
    ...
    while True:
        ...
        while datetime.now() < end_time:
            ...
            process_debut = execute_macro(r"C:\Users\camil\Desktop\Eat the world Bot op\macro_debut.exe")
            wait_for_process_to_end(process_debut)
            print("[INFO] Fin de macro_debut.exe")
            process_debut = execute_macro(r"C:\Users\camil\Desktop\Eat the world Bot op\échap.exe")
        ...
        process_periodique = execute_macro(r"C:\Users\camil\Desktop\Eat the world Bot op\macro_periodique1.exe")
        ...
        process_achat_multi = execute_macro(r"C:\Users\camil\Desktop\Eat the world Bot op\macro_achat_maxsize.exe")
